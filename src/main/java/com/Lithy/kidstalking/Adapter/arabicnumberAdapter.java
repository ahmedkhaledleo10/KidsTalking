...
public class arabicnumberAdapter extends PagerAdapter {
    ...
    public arabicnumberAdapter(Context context, List<screen_arabicnumber> items) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view=inflater.inflate(R.layout.item_number_arabic,null);
