...
public class englishcolorAdapter extends PagerAdapter {

    Context context;
    List<screen_englishcolor> items;


    public englishcolorAdapter(Context context, List<screen_englishcolor> items) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view=inflater.inflate(R.layout.item_english_color,null);
