...
public class arabletterAdapter extends PagerAdapter {

    Context context;
    List<screen_letterarab>items;


    public arabletterAdapter(Context context, List<screen_letterarab> items) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View view=inflater.inflate(R.layout.item_letter_arabic,null);
